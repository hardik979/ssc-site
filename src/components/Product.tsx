...
const HeroCategories: React.FC = () => {
  ...
  return (
    <section className="w-full bg-linear-to-b from-gray-100 to-gray-200 py-12 md:py-16 lg:py-24 overflow-hidden relative">
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-center">
          ...
          >
            ...
            <button className="text-gray-900 font-semibold text-base md:text-lg border-b-2 border-gray-900 pb-1 hover:text-gray-700 hover:border-gray-700 transition-colors">
              View More Products
            </button>
          </motion.div>

          {/* Right Side - Carousel */}
          <div className="w-full lg:w-[65%] relative flex-1">
              ...
              <div className="relative w-full max-w-md mx-auto">
                <AnimatePresence mode="wait">
                  <motion.div
                    ...
                    className="bg-[#e4b944] rounded-3xl p-6 shadow-2xl relative"
                  >
                    {/* Diagonal Pattern */}
                    <div
                    ...
                    <button
                      onClick={prevSlide}
                      className="absolute left-4 top-32 z-40 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
                      aria-label="Previous"
                    >
                    ...
                    <button
                      onClick={nextSlide}
                      className="absolute right-4 top-32 z-40 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform"
                      aria-label="Next"
                    >
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Button */}
                      <button className="w-full py-3.5 rounded-full font-semibold bg-[#2c3241] text-white hover:scale-105 transition-all duration-200 shadow-md">
                        View More
                      </button>
                    </div>
